                                    ...
                                    <form class="form-inline my-2 my-lg-0" target="_blank" action="/Constanciasamc/Usuario/" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-12 mt-md-2">
                                                <button class="btn max-btn-lg bg-gradient-pink-white text-white my-2 my-sm-0" type="submit">↑↑↑ ¡Ingrese su nombre completo para descargar su constancia! ↑↑↑</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
